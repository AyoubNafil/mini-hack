"use strict";
(self["webpackChunkinovascrum"] = self["webpackChunkinovascrum"] || []).push([["src_views_apps_tasks_list-view_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/apps/tasks/list-view.vue?vue&type=script&lang=js":
/*!*************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/apps/tasks/list-view.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _api_utile_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../api/utile.js */ "./src/api/utile.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    resultQuery() {
      if (this.searchQuery) {
        ...
        return this.displayedPosts.filter(data => {
          return data.Name.toLowerCase().includes(search) || data.CreatedDate.toLowerCase().includes(search) || data.Type__r.Board__r.Name.toLowerCase().includes(search) || data.Type__r.Name.toLowerCase().includes(search);
        });
  ...
  methods: {
    ...
    async getCaseDetail() {
      try {
        this.tot = await (0,_api_utile_js__WEBPACK_IMPORTED_MODULE_13__.executeQuery)("SELECT Id FROM Task__c");
        if (this.tot && this.tot.length > 0) {
          this.tot = this.tot.length;
        }
        this.pen = await (0,_api_utile_js__WEBPACK_IMPORTED_MODULE_13__.executeQuery)("SELECT Id FROM Task__c where  Type__r.Name!='done' and Type__r.Name!='completed'");
        if (this.pen && this.pen.length > 0) {
          this.pen = this.pen.length;
        }
        this.clo = await (0,_api_utile_js__WEBPACK_IMPORTED_MODULE_13__.executeQuery)("SELECT Id FROM Task__c where  Type__r.Name='done' or Type__r.Name='completed'");
        if (this.clo && this.clo.length > 0) {
          this.clo = this.clo.length;
        }
        this.tasksList = await (0,_api_utile_js__WEBPACK_IMPORTED_MODULE_13__.executeQuery)("SELECT Id, Name, Type__r.Board__r.Name, Type__r.Name, CreatedDate, CreatedBy.Name, Points__c FROM Task__c ");
    ...
    updateorder() {
      let result = this.tasksList.findIndex(o => o.id == document.getElementById("orderId").value);
      ...
      axios__WEBPACK_IMPORTED_MODULE_14__["default"].patch(`https://api-node.themesbrand.website/apps/task/${this.tasksList[result]._id}`, this.tasksList[result]).then(() => {}).catch(er => {
        console.log(er);
      });
    },
    deletedata(event) {
      sweetalert2__WEBPACK_IMPORTED_MODULE_9___default().fire({
        ...
        if (result.value) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_14__["default"]["delete"](`https://api-node.themesbrand.website/apps/task/${event._id}`).then(() => {}).catch(er => {
            console.log(er);
          });
    ...
    addorder() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_14__["default"].post(`https://api-node.themesbrand.website/apps/task`, data).then(() => {}).catch(er => {
        console.log(er);
      });
      document.getElementById("closemodal").click();
  ...
  async mounted() {
    ...
    Array.from(checkboxes).forEach(function (element) {
      element.addEventListener("change", function (event) {
        var checkedCount = document.querySelectorAll("#tasksList .form-check-input:checked").length;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/apps/tasks/list-view.vue?vue&type=template&id=e41e90a0":
/*!*****************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/apps/tasks/list-view.vue?vue&type=template&id=e41e90a0 ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
}, "Task"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
  class: "sort",
  "data-sort": "id"
...
}, "Points"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
  class: "sort",
...
const _hoisted_51 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h5", {
  class: "mt-2"
}, "Sorry! No Result Found", -1 /* HOISTED */);
const _hoisted_52 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
  class: "text-muted mb-0"
}, " We've searched more than 150+ Tasks We did not find any Tasks for you search. ", -1 /* HOISTED */);
const _hoisted_53 = {
...
const _hoisted_58 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
...
const _hoisted_59 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
...
const _hoisted_60 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
...
const _hoisted_64 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
  class: "form-control",
  "data-plugin": "choices",
  name: "task-status",
  id: "taskstatus"
...
const _hoisted_66 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
  class: "form-control",
  "data-plugin": "choices",
  name: "priority-field",
  id: "priority"
          ...
          default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_card_header, {
            ...
            default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_34, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("table", _hoisted_35, [_hoisted_36, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tbody", _hoisted_37, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.resultQuery, (data, index) => {
              return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tr", {
                ...
                _: 2 /* DYNAMIC */
              }, 1032 /* PROPS, DYNAMIC_SLOTS */, ["to"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_40, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(data.Type__r.Board__r.Name), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_41, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
              ...
              }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(data.Type__r.Name), 3 /* TEXT, CLASS */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_42, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(data.Points__c), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_43, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(data.CreatedDate.substring(0, 10)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_44, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_link, {
                ...
                _: 1 /* STABLE */
              }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ul", _hoisted_46, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
                class: "dropdown-item",
                to: `/apps/tasks-details/${data.Id}`
              }, {
                default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [_hoisted_47, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("View ")]),
                _: 2 /* DYNAMIC */
                ...
                default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [_hoisted_48, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Edit ")]),
                _: 1 /* STABLE */
            ...
            }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_50, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_lottie, {
              class: "avatar-xl",
              colors: "primary:#121331,secondary:#08a88a",
              options: $data.defaultOptions,
              height: 90,
              width: 90
            }, null, 8 /* PROPS */, ["options"]), _hoisted_51, _hoisted_52])], 2 /* CLASS */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_53, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_54, [$data.page != 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_b_link, {
              key: 0,
              ...
              _: 1 /* STABLE */
            })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ul", _hoisted_55, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.pages, (pageNumber, index) => {
              return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
                ...
                _: 2 /* DYNAMIC */
              }, 1024 /* DYNAMIC_SLOTS */)], 10 /* CLASS, PROPS */, _hoisted_56);
      ...
      default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_form, {
        ...
        default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_row, {
          ...
          default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_col, {
            ...
            default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [_hoisted_57]),
            _: 1 /* STABLE */
          }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_col, {
            lg: "12"
          }, {
            ...
            default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [_hoisted_59]),
            _: 1 /* STABLE */
          }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_col, {
            lg: "6"
          }, {
            ...
            default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [_hoisted_61, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_flat_pickr, {
            ...
            default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [_hoisted_62, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_flat_pickr, {
            ...
            default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [_hoisted_63, _hoisted_64]),
            _: 1 /* STABLE */
          }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_col, {
            lg: "6"
          }, {
            default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [_hoisted_65, _hoisted_66]),
            _: 1 /* STABLE */
          })]),

          _: 1 /* STABLE */
        }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_67, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_68, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_button, {
          type: "button",
          variant: "light",
...
/***/ "./src/views/apps/tasks/list-view.vue":
/*!********************************************!*\
  !*** ./src/views/apps/tasks/list-view.vue ***!
  \********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _list_view_vue_vue_type_template_id_e41e90a0__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list-view.vue?vue&type=template&id=e41e90a0 */ "./src/views/apps/tasks/list-view.vue?vue&type=template&id=e41e90a0");
/* harmony import */ var _list_view_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./list-view.vue?vue&type=script&lang=js */ "./src/views/apps/tasks/list-view.vue?vue&type=script&lang=js");
...
;
const __exports__ = /*#__PURE__*/(0,D_Extention_corporateVueExtention2_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_list_view_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_list_view_vue_vue_type_template_id_e41e90a0__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"src/views/apps/tasks/list-view.vue"]])
/* hot reload */
if (false) {}
...
/***/ "./src/views/apps/tasks/list-view.vue?vue&type=script&lang=js":
/*!********************************************************************!*\
  !*** ./src/views/apps/tasks/list-view.vue?vue&type=script&lang=js ***!
  \********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_40_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_list_view_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]; }
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_40_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_list_view_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./list-view.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/apps/tasks/list-view.vue?vue&type=script&lang=js");
 

/***/ }),

/***/ "./src/views/apps/tasks/list-view.vue?vue&type=template&id=e41e90a0":
/*!**************************************************************************!*\
  !*** ./src/views/apps/tasks/list-view.vue?vue&type=template&id=e41e90a0 ***!
  \**************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": function() { return /* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_40_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_list_view_vue_vue_type_template_id_e41e90a0__WEBPACK_IMPORTED_MODULE_0__.render; }
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_40_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_list_view_vue_vue_type_template_id_e41e90a0__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!../../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./list-view.vue?vue&type=template&id=e41e90a0 */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/apps/tasks/list-view.vue?vue&type=template&id=e41e90a0");


/***/ })

}]);
//# sourceMappingURL=src_views_apps_tasks_list-view_vue.js.map